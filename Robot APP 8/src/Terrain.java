...
public class Terrain extends JPanel {
	...
	public void ajouterObstaclesAleatoiresIsoles(int nbObstacles) {
		...
		// dans le meilleur des cas, on peut ajouter 25 obstacles, on normalise donc
		// le nb d'obstacles
		if (nbObstacles>30){
			nbObstacles=30;
			// utile pour eviter la surcharge du proco
		}
		...
		for (int i = 0; i < nbObstacles; i++) {
			...
			if ( (!isObstacleACote(l, c)) && ((l!=0) && (c!=0)) ) {
				//si on est pas en (0,0) et si il n'y a pas d'obstacles à côté
